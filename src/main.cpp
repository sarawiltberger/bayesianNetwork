...
//#define MNIST_DATA_DIR "/Users/sarawiltberger/Desktop/project3/mnist_data"
int main(int argc, char* argv[]) {
    ...
    BaysianNetwork bayNetwork(trainImages, trainLabels, testImages, testLabels, numLabels, numFeatures);
    //output bitmap
    bayNetwork.outputBitmap();
    //output to network.text
    bayNetwork.outputNetwork("../output/network.txt");
    //output classification
    bayNetwork.outputClassification("../output/classification-summary.txt");
    /*
